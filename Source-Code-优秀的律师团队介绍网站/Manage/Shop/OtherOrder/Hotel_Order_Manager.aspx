  ...
  <table class="table table-striped table-bordered table-hover">
    <tr>
      <td><span class="pull-left"> 高级查询：
        <asp:DropDownList ID="souchtable" CssClass="form-control" style="width:120" runat="server">
  ...
  <table class="table table-striped table-bordered table-hover">
    <tbody id="Tbody1">
      <tr class="tdbg text-center">
        ...
        <td style="width:160px;"><span>入住时间</span></td>
        <td style="width:68px"><span>实际金额</span></td>
        <td style="width:65px;"><span>收款金额</span></td>
        <td style="width:75px;white-space: nowrap;"><span>已开发票</span></td>
        <td style="width:75px;"><span>订单状态</span></td>
        <td style="width:75px;"><span>付款状态</span></td>
        <td style="width:75px;"><span>其他费用</span></td>
      </tr>
      <ZL:ExRepeater ID="Order_RPT" PageSize="10" runat="server" PagePre="<tr><td><input type='checkbox' id='chkAll'/></td><td colspan='10' class='text-center'>" PageEnd="</td></tr>">
        <ItemTemplate>
